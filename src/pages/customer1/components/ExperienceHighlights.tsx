    ...
    <section className="flex flex-col gap-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {highlights.map(({ id, title, copy, Icon }) => (
          <article
            key={id}
            className="relative overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-white/8 to-white/2 p-[1px]"
          >
            <div className="relative h-full rounded-[calc(1.5rem-1px)] bg-[#0D1428]/90 p-7 shadow-[0_20px_60px_-40px_rgba(0,0,0,0.9)]">
              <div className="absolute -top-20 left-1/2 h-40 w-40 -translate-x-1/2 rounded-full bg-[#D6B35A]/15 blur-[110px]" />
              <div
                className={clsx(
              ...
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[#D6B35A]/50 bg-[#D6B35A]/10 backdrop-blur">
