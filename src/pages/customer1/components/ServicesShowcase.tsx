      ...
      <div className="grid gap-5 lg:grid-cols-2">
        {loyaltyElement && (
          <motion.div
            ...
            className="relative overflow-hidden rounded-[30px] border border-[#D6B35A]/40 bg-gradient-to-br from-[#D6B35A]/10 via-[#D6B35A]/5 to-[#2a2a2a] p-[1px]"
          >
            <div className="relative h-full overflow-hidden rounded-[29px] bg-gradient-to-br from-[#252525] to-[#1f1f1f] p-8">
              <div className="pointer-events-none absolute inset-0">
                <div className="absolute -top-16 left-1/2 h-40 w-40 -translate-x-1/2 rounded-full bg-[#F4D47A]/25 blur-[120px]" />
                <div className="absolute bottom-0 right-0 h-48 w-48 rounded-full bg-[#D6B35A]/20 blur-[120px]" />
              </div>
              ...
              >
                <span className="inline-flex w-max items-center gap-2 rounded-full border border-[#F4D47A]/40 bg-[#F4D47A]/15 px-4 py-1 text-xs font-semibold uppercase tracking-[0.35em] text-[#FCE9AE]">
