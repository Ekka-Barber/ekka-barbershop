            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-[#C4A36F]" />
                  <span className="text-gray-700">ekka.barber@gmail.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Clock className="w-5 h-5 text-[#C4A36F]" />
        ...
        <section>
          ...
          {isLoading ? (
            <div className="text-center py-8">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#C4A36F] mx-auto"></div>
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">
                        ...
                        {branch.name === 'Al-Waslyia' && (
                          <span className="ml-2 text-sm bg-[#C4A36F] text-white px-2 py-1 rounded">
