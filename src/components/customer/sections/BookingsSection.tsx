...
const BookingsSection = ({ element, isVisible, onOpenBookingsDialog }: BookingsSectionProps) => {
  ...
  return (
    ...
    >
      <div className="mt-3 bg-gradient-to-br from-white/95 via-white/90 to-white/85 rounded-2xl shadow-[0_20px_45px_-15px_rgba(0,0,0,0.15),0_10px_25px_-10px_rgba(214,179,90,0.1)] border-2 border-white/40 p-5 cursor-pointer hover:border-[#E8C66F]/30 transition-all duration-300 backdrop-blur-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="h-12 w-[2px] bg-gradient-to-b from-[#E8C66F]/40 via-[#D6B35A]/30 to-transparent mx-4 shadow-[0_0_10px_rgba(232,198,111,0.2)]"></div>
          <motion.div 
