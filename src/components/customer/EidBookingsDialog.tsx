  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        >
          <SheetHeader className="h-28 bg-gradient-to-r from-[#E8C66F] via-[#D6B35A] to-[#C79A2A] flex items-center justify-center relative overflow-hidden shadow-[0_10px_40px_-10px_rgba(232,198,111,0.5)] flex-shrink-0">
            <motion.div
