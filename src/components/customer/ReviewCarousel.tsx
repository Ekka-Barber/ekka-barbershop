        ...
        {visibleReviews().map((review, index) => {
          ...
          return (
            <Card 
              ...
              className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col rounded-xl overflow-hidden animate-fadeIn"
            >
              ...
              <CardContent className="p-4 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <div className={cn("flex items-start mb-2", 
                  ...
                  <p className={cn("text-gray-600 text-xs leading-relaxed", 
                    isLongReview ? "line-clamp-3" : ""
                  )}>
                ...
                {isLongReview && (
                  <div className="mt-2">
                    ...
                    >
                      ...
                      <span className={cn(
                        language === 'ar' ? "mr-1 ml-0 transform rotate-180" : "ml-1"
                      )}>&rarr;</span>
                    </button>
                  </div>
                )}
          ...
          {[...Array(totalPages)].map((_, i) => (
            <button
              ...
              className={cn(
                ...
                i === currentPage 
                  ? "bg-[#C4A36F] w-3" // Active dot is larger
