        ...
        <div className="space-y-4 mt-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="flex flex-col items-center p-2 bg-white rounded border">
                  ...
                  <span className="text-sm font-bold text-[#ea384c]">
                    {language === 'ar' 
                      ? convertToArabic(packageSettings.discountTiers.oneService.toString()) + '%'
                ...
                <div className="flex flex-col items-center p-2 bg-white rounded border">
                  ...
                  <span className="text-sm font-bold text-[#ea384c]">
                    {language === 'ar' 
                      ? convertToArabic(packageSettings.discountTiers.twoServices.toString()) + '%'
                ...
                <div className="flex flex-col items-center p-2 bg-white rounded border">
                  ...
                  <span className="text-sm font-bold text-[#ea384c]">
                    {language === 'ar' 
                      ? convertToArabic(packageSettings.discountTiers.threeOrMore.toString()) + '%'
          ...
          {packageSettings?.maxServices && (
            <p className="text-sm text-gray-600">
              ...
              {language === 'ar' 
                ? `الحد الأقصى للخدمات الإضافية هو ${convertToArabic(packageSettings.maxServices.toString())}`
