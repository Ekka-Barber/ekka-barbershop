...
interface NoReviewsProps {
  language: Language;
  hasReviewsInOtherLanguage?: boolean;
}

export const NoReviews = ({ language, hasReviewsInOtherLanguage = false }: NoReviewsProps) => (
  <div className="w-full py-8 text-center">
    <div className="bg-gray-50 rounded-lg p-8 max-w-md mx-auto">
      ...
      <p className="text-gray-500 text-sm">
        {hasReviewsInOtherLanguage ? (
          language === 'ar' ? 'المراجعات متاحة باللغة الإنجليزية فقط.' : 'Reviews are available in Arabic only.'
        ) : (
