  ...
  return (
    <motion.div
      ...
      whileHover={{ 
        scale: 1.03, 
        y: -4,
        boxShadow: "0 25px 50px -12px rgba(232,198,111,0.3), 0 15px 30px -10px rgba(214,179,90,0.2)" 
      }}
    ...
    >
      <div className="mt-3 bg-gradient-to-br from-white/95 via-white/90 to-white/85 rounded-2xl shadow-[0_20px_45px_-15px_rgba(0,0,0,0.15),0_10px_25px_-10px_rgba(214,179,90,0.1)] border-2 border-white/40 p-5 cursor-pointer hover:border-brand-gold-300/40 transition-all duration-300 backdrop-blur-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="h-12 w-[2px] bg-gradient-to-b from-brand-gold-300/40 via-brand-gold-200/30 to-transparent mx-4 shadow-[0_0_10px_rgba(232,198,111,0.2)]"></div>
          <motion.div 
